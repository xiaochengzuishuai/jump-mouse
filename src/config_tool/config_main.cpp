...
//
// Usage:
//   mouse_focus_config.exe              — edit config.json in exe directory
//   mouse_focus_config.exe <configPath> — edit specified config file
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, int) {
    ...
    // Show initially; on close, it hides to tray.
